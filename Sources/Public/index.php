...
// in case of remote access to db, don't show title
if ($_SESSION['Hide'] != 2)
	echo "<h1>$title $subtitle</h1>\n\n";
...
if ($_SESSION['Hide'] != 2)
{
 ...
 echo "
		...
		<tr><td width=33% align='center'>$cell1</td>
		<td width=34% align='center'>$cell2</td>
		<td width=33% align='center'>$cell3</td>
		</tr></table>
 ";
...
function pageIndex()
{
  ...
  if ($nbPublis>$nbPerPage)
      ...
      else
	{
      ...
      $href="  <a href='$local_server$public_path/.$param";
